...
import defaultUser from '../../images/user/user-01.png'; // fallback image
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const response = await fetch('https://outcheck-backend.onrender.com/api/admin/profile', {
          method: 'GET',
          headers: {
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full overflow-hidden">
          <img
            src={profile ? profile.profilePic : defaultUser}
          ...
          <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M11 9.625C8.42188 9.625 6.35938 7.59688 6.35938 5.12188C6.35938 2.64688 8.42188 0.61875 11 0.61875C13.5781 0.61875 15.6406 2.64688 15.6406 5.12188C15.6406 7.59688 13.5781 9.625 11 9.625ZM11 2.16563C9.28125 2.16563 7.90625 3.50625 7.90625 5.12188C7.90625 6.7375 9.28125 8.07813 11 8.07813C12.7188 8.07813 14.0938 6.7375 14.0938 5.12188C14.0938 3.50625 12.7188 2.16563 11 2.16563Z"
                    fill=""
                  />
                  <path
                    d="M17.772 21.416H4.228C3.5405 21.416 2.9905 20.865 2.9905 20.178V17.084C2.9905 13.715 5.7405 10.965 9.10925 10.965H12.925C16.2938 10.965 19.0438 13.715 19.0438 17.084V20.178C19.0094 20.831 18.4594 21.416 17.772 21.416ZM4.53775 19.869H17.497V17.084C17.497 14.575 15.4345 12.5125 12.9251 12.5125H9.0751C6.56572 12.5125 4.50322 14.575 4.50322 17.084V19.869H4.53775Z"
                    fill=""
                  />
                </svg>
                My Profile
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M17.669 1.44374C17.119 0.893744 16.4315 0.618744 15.6753 0.618744H7.42532C6.25657 0.618744 5.25969 1.58124 5.25969 2.78437V4.12499H4.29719C3.88469 4.12499 3.50657 4.46874 3.50657 4.91562C3.50657 5.36249 3.85032 5.70624 4.29719 5.70624H5.25969V10.2781H4.29719C3.88469 10.2781 3.50657 10.6219 3.50657 11.0687C3.50657 11.4812 3.85032 11.8594 4.29719 11.8594H5.25969V16.4312H4.29719C3.88469 16.4312 3.50657 16.775 3.50657 17.2219C3.50657 17.6687 3.85032 18.0125 4.29719 18.0125H5.25969V19.25C5.25969 20.4187 6.22219 21.4156 7.42532 21.4156H15.6753C17.2223 21.4156 18.4942 20.1437 18.5286 18.5969V3.47187C18.4942 2.68124 18.2192 1.95937 17.669 1.44374ZM16.9472 18.5625C16.9472 19.2844 16.3628 19.8344 15.641 19.8344H7.391C7.04725 19.8344 6.77225 19.5594 6.77225 19.2156V17.875H8.6285C9.041 17.875 9.41913 17.5312 9.41913 17.0844C9.41913 16.6375 9.07538 16.2937 8.6285 16.2937H6.77225V11.79H8.6285C9.041 11.79 9.41913 11.4469 9.41913 11C9.41913 10.5875 9.07538 10.2438 8.6285 10.2438H6.77225V5.63749H8.6285C9.041 5.63749 9.41913 5.29374 9.41913 4.84687C9.41913 4.39999 9.07538 4.05624 8.6285 4.05624H6.77225V2.75C6.77225 2.40624 7.04725 2.13124 7.391 2.13124H15.641C15.985 2.13124 16.2942 2.26874 16.5682 2.50937C16.809 2.75 16.9472 3.09374 16.9472 3.43749V18.5625Z"
                    fill=""
                  />
                </svg>
                My Contacts
